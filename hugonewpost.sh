...
echo "\033[32m\033[01m	=======================\033[0m"
echo "\033[32m\033[01m	\n	键入博客文件名\n\033[0m"
read -p "	: " newpost && sleep 2
rm ${newpost}.md && rm ${hugogeneral}/${newpost}.md && rm ${hugogeneral}/${newpost}-.md
echo "\033[32m033[01m	删除旧有文件\033[0m"
...
hugo new ${hugogeneral}/${newpost}-.md
sleep 5 && cd
echo "\033[32m\033[01m	写入文件\033[0m"
sleep 1
cd ${basedirectory}
sleep 1
pwd
...
sleep 1
rm -rf ${hugogeneral}/${newpost}.md
sleep 1 && echo "\033[32m\033[01m	修改.md为可部署状态\033[0m"
sed  -i '4s/draft: true/draft: false/g' ${hugogeneral}/${newpost}-.md 
cd xxxx && hugo && sleep 3
cd public && pwd
echo "\033[32m\033[01m	推送\033[0m" && sleep 1
git add .
git commit -m "update"
git push && sleep 2
echo "\033[32m\033[01m	ok bye\033[0m" && sleep 2
echo "\033[32m\033[01m	=======================\033[0m"
