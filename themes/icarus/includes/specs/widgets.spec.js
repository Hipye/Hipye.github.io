...
const DEFAULT_WIDGETS = [
    {
        ...
        follow_link: 'https://github.com/hipye',
        social_links: {
            Github: {
                icon: 'fab fa-github',
                url: 'https://github.com/hipye'
            },
            Facebook: {
    ...
    },
    {
        ...
        links: {
            Hexo: 'https://hexo.io',
            PPOffice: 'https://github.com/hipye'
        }
    },
    {
        type: 'category',
...
const ProfileSpec = {
    author: {
        ...
        [defaultValue]: 'Hipye Page`s'
    },
    author_title: {
        [type]: 'string',
        [doc]: 'Title of the author to be shown in the profile widget',
        [defaultValue]: 'Nothing is True. Everything is permitted.'
    },
    location: {
        [type]: 'string',
